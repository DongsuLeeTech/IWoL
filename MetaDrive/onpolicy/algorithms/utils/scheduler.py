...
class Scheduler(nn.Module):
    ...
    """
    def __init__(self, args, obs_shape, hidden_size, num_heads, negative_slope):
        ...
        self.temperature = max(final_temperature, initial_temperature * (decay_rate ** args.num_env_steps))
