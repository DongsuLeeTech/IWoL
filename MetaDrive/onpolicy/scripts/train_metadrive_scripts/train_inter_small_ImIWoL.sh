...
do
    ...
    --n_training_threads 1 --n_rollout_threads 2 --num_mini_batch 1  --num_env_steps 10000000 \
    --ppo_epoch 15 --log_interval 10 --use_eval --eval_interval 50 --n_eval_rollout_threads 1 \
    --lr 3e-4 --critic_lr 3e-4 --hidden_size 8 \
    ...
    --comm_type 1 --num_comm_hops 1 --comm_hidden_size 8 --comm_num_heads 1 \
