...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=2 python ../train/train_ExIWoL.py --env_name ${env} --algorithm_name ${algo} \
    ...
    --meta_lidar_num_lasers 2 --meta_lidar_dist 10 --meta_lidar_num_others 7 \
