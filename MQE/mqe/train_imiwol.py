...
from mqe.algorithms.marl.ImIWoL_runner import ImIWoL_Runner
import torch
...
def main():
    ...
    # Load configuration
    config_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cfg/imiwol/config.yaml")
