...
from mqe.algorithms.marl.ExIWoL_runner import ExIWoL_Runner
import torch
...
def main():
    ...
    # Load configuration
    config_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cfg/exiwol/config.yaml")
